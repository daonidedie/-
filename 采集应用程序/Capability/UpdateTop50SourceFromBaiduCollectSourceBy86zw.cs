...
namespace Skybot.Collections
{
    ...
    /// 更新小说百度搜索榜单中的前50
    /// </summary>
    public class UpdateTop50SourceFromBaiduCollectSourceBy86zw : System.ComponentModel.INotifyPropertyChanged
    {
...
// "yankuai.com",
 ...
 "17k.com",
        ...
        /// 创建一个新的更新搜索实例
        /// </summary>
        public UpdateTop50SourceFromBaiduCollectSourceBy86zw()
        {
    ...
    || xo.Status == System.Threading.Tasks.TaskStatus.Canceled)
        ...
        public void UpdateDefaultPage()
        {
            ...
            try
            {
                ...
                wc.DownloadString("http://qlili.com/file/App.aspx?" + Guid.NewGuid());
                System.Diagnostics.UDPGroup.SendStrGB2312(DateTime.Now + "更新首页成功...http://www.qlili.com/");
            }
            catch (Exception ex)
            {
                //打印状态
