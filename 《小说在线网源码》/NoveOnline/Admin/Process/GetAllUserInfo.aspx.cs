...
using BllFactory;
using System.Text;
public partial class Admin_Process_GetAllUserInfo : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        INovel novel = BllFactory.BllAccess.CreateINovelBLL();
        int userType = Convert.ToInt32(Request["userType"]) > 0 ? Convert.ToInt32(Request["userType"]) : 0;
        List<Model.UsersInfo> list = novel.getUserInfoAll(userType);
